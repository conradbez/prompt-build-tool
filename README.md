...
Expressing a map in pbt is only as useful as knowing that the path followed matches intuitive clues along the way - if you want to get home and understand to go left but miss a turn you have yes/no tests along your walk - that is `pbt test`. More: [`tests/README.md`](tests/README.md).
